...
def main(cfg: DictConfig):
    images, labels = find_images(cfg.dataset.dataset_dir)
    (train, y_train), (val, y_val), (test, y_test) = split(images, labels, cfg.dataset.total_fraction)
    ...
    train_dataset, val_dataset, test_dataset = prepare_dataset(cfg.dataset.output_dir)
